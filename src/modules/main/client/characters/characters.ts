...
@Spritesheet({
    ...
    textures: {
        [Animation.Stand]: {
            animations: direction => [
                [{ time: 0, frameX: 0, frameY: frameY(direction), scale: [0.75, 0.75] }]
            ]
        },
        [Animation.Walk]:  {
            animations: direction => [
                [
                    { time: 0, frameX: 0, frameY: frameY(direction) , scale: [0.75, 0.75]},
                    { time: 4, frameX: 1, frameY: frameY(direction) , scale: [0.75, 0.75]},
                    { time: 8, frameX: 2, frameY: frameY(direction) , scale: [0.75, 0.75]},
                    { time: 12, frameX: 3, frameY: frameY(direction) , scale: [0.75, 0.75]}
                ]
            ]
        }
    }
